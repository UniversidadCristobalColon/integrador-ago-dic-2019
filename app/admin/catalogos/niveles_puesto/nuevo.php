    ...
    function validaFormulario(params) {
        ...
        if (
            ...
            Swal.fire({
                icon: 'error',
                title: 'Error...',
                text: 'Debes introducir los campos requeridos'
            });
            mostrarErrores();
        }
    ...
    <div id="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form id="agregar" action="guardarNivelP.php" method="post">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Nivel de Puesto:</label>
                                    <input type="text" name="nivel_puesto" class="form-control" placeholder="Introduce el Nivel de Puesto">
                                </div>
                            </div>
                        </div>
