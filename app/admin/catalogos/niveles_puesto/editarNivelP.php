...
if(isset($_POST['cambiar'])){
    ...
    $find=mysqli_query($conexion,"SELECT * FROM niveles_puesto WHERE id='$cambiar'");
    $row=mysqli_fetch_array($find);
    $estado=$row['estado'];

    if($estado == "Activo"){
        $sqlCambiar = "UPDATE niveles_puesto SET estado = 'Inactivo' WHERE id = '$cambiar' ";
    }else{
        $sqlCambiar = "UPDATE niveles_puesto SET estado = 'Activo'  WHERE id = '$cambiar' ";
    }
...
if(isset($_POST['editar'])){
        ...
        function validaFormulario(params) {
            ...
            if (
                ...
                Swal.fire({
                    icon: 'error',
                    title: 'Error...',
                    text: 'Debes introducir el Nivel de Puesto'
                });
                mostrarErrores();
            }
            if (
    ...
    <?php
    $buscar=mysqli_query($conexion,"SELECT * FROM niveles_puesto WHERE id='$id'");
        ...
        <div id="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="agregar" action="guardar_EditarNivelP.php" method="post">
                            <div class="row">
                                <div class="col-md-12">
