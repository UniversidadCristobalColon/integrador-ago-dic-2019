                    ...
                    <div class="row">
                        <div class = "col-md-4">
                            <div class="form-group">
                                <label>Puesto</label>
                                <input type="text" name="puesto" class="form-control" placeholder="Introduzca el Puesto">
                            </div>
                        </div>
                    </div>
                    ...
                    <form id="agregar" action="guardar.php" method="post">
                        <div class="row">
                            <div class = "col-md-4">
                                <div class="form-group">
                                    <label>ID</label>
                                    <input type="text" name="ID" class="form-control" placeholder="Introduzca el ID del Puesto">
                                </div>
                            </div>
                        </div>
