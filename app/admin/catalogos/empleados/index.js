var users = [{
    ...
    "updated_at": "2019/02/03"
}, {
    "username": "sdronsfield6",
    "status": "C",
    "created_at": "2019/07/24",
    "updated_at": "2018/12/17"
}, {
    "username": "ptrevaskiss7",
    "status": "B",
    ...
    "updated_at": "2019/06/03"
}, {
    "username": "ckirkwoodg",
    "status": "B",
    "created_at": "2019/01/23",
    "updated_at": "2018/11/17"
}, {
    "username": "lgeharkeh",
    "status": "A",
...
for(let i = 0; i < users.length; i ++){
    ...
    usr.setAttribute("class", "text-center");
    let sts = document.createElement("td");
    sts.textContent = users[i].status;
    sts.setAttribute("class", "text-center");
    let cra = document.createElement("td");
    cra.textContent = users[i].created_at;
    cra.setAttribute("class", "text-center");
    let upa = document.createElement("td");
    upa.textContent = users[i].updated_at;
    upa.setAttribute("class", "text-center");
