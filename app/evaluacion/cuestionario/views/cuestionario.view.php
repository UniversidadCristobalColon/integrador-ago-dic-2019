        ...
        <div id="content-wrapper">
            ...
            <?php if( $vista_html == true ): ?>
                <div class="container">
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            ...
                            <i class="fas fa-tasks"></i>
                                <?php echo $evaluacion_info['cuestionario'] ?>
                            <hr>
                            <!-- ROW -->
                            <div class="row">
                                <div class="col-6">
                                    <small><b class="mr-1">Evaluando a:</b>
                                        <?php
                                            echo $evaluacion_info['nombre'] . ' ' . $evaluacion_info['apellidos']
                                        ?>
                                    </small>
                                    <br>
                                    <small><b class="mr-1">Fecha de cierre:</b>
                                        <?php
                                            echo $evaluacion_info['fin']
                                        ?>
                                    </small>
                                </div>
                                <div class="col-6">
                    ...
                    <div class="row">
                        <div class="col">
                            <button class="btn btn-primary btn-block mb-3" type="submit" name="id_aplicacion" value="<?php echo $id_evaluacion ?>">
                                <?php
                ...
                <div class="container">
                     ...
                     <div class="card mb-3">
                        ...
                        <!-- MOSTRAR O NO VISTA POST -->
                            ...
                            <h4>Su cuestionario ha sido enviado con éxito</h4>
                        </div>
                        <!-- DIV CARD-BODY -->
